...
long sys_rt_sigaction(int sig, const struct sigaction *act, struct sigaction *oact, size_t sigsetsize);	// sigaction
long sys_rt_sigprocmask(int how, const sigset_t *nset, sigset_t *oset, size_t sigsetsize);	// sigprocmask
long sys_pipe(int *filedes);
long sys_dup(int filedes);
long sys_dup2(int oldfd, int newfd);
long sys_pause();
long sys_nanosleep(struct timespec *rqtp, struct timespec *rmtp);
long sys_alarm(unsigned int seconds);	// alarm
long sys_fork(void);
...
long sys_geteuid();
long sys_getegid();
long sys_rt_sigpending(sigset_t *set, size_t sigsetsize);	// sigprocmask
...
int	sigaction(int signum, struct sigaction *act, struct sigaction *oldact);	// sigaction
int	sigprocmask(int how, const sigset_t *set, sigset_t *oldset);	// sigprocmask
int	pipe(int *filedes);
int	dup(int filedes);
int	dup2(int oldfd, int newfd);
int	pause();
int	nanosleep(struct timespec *rqtp, struct timespec *rmtp);
unsigned int	alarm(unsigned int seconds);	// alarm
pid_t	fork(void);
...
uid_t	geteuid();
gid_t	getegid();
int	sigpending(sigset_t *set);	// sigpending
