...
long sys_rt_sigprocmask(int how, const sigset_t *set, sigset_t *oldset, size_t sigsetsize);	// sigprotect
...
long sys_geteuid();
long sys_getegid();
long sys_rt_sigpending(sigset_t *set, size_t sigsetsize);	//sigpending
